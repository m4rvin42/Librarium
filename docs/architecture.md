...
The metadata module maps Open Library data into provider-neutral records, with request identity, abort timeouts, backoff, and cache expiry. A future provider implements the same shape.
